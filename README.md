...
Same engine, same guardails: every run is permission-gated, audited into a provenance ledger, and untrusted content from issues/PSs is fenced against prompt injection.
